...
class Form:
    ...
    def rendernote(self, note):
        if note: return '<strong class="errors">%s</strong>' % note
        else: return ""
...
class Input(object):
    def __init__(self, name, *validators, **attrs):
        self.markwrong = attrs.pop('markwrong', True)
        ...
        if 'class_' in attrs:
            ...
            del attrs['class_']
        self.name, self.validators, self.attrs, self.note, self.errors = name, validators, attrs, None, []
